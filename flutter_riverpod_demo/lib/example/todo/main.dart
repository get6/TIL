...
/// object, with advanced business login like how to edit a todo.
final todoListProvider = StateNotifierProvider<TodoList>((ref) {
  return TodoList([
    Todo(id: 'todo-0', description: 'h1'),
...
/// the value sice it's just enum.
final todoListFilter = StateProvider((_) => TodoListFilter.all);

/// The number of uncompleted todos
///
/// By using [Provider], this value is cached, making it performat.\
      ...
      child: Focus(
        ...
        onFocusChange: (focused) {
          if (focused) {
            ...
            // Comit changes only when the textfield is unfocused, for performance
            context
