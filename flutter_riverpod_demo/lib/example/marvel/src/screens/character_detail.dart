...
///   [selectedCharaterId] to set the ID based by parsing the route path.
///
...
///
/// This rarely perform using deep-links, a user may want to see a [Character]
...
final character = $family<Character, String>((ref, id) async {
  // The user used a deep-link to land in ther Character page, so we fetch
