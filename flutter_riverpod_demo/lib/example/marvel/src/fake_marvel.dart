...
@JsonLiteral('lib/example/marvel/src/json/characters.json')
final _characters = _$_charactersJsonLiteral;

@JsonLiteral('lib/example/marvel/src/json/characters_20.json')
final _characters20 = _$_characters20JsonLiteral;

@JsonLiteral('lib/example/marvel/src/json/characters_name= Iron man.json')
final _charactersIronMan = _$_charactersIronManJsonLiteral;

@JsonLiteral('lib/example/marvel/src/json/characters_name= Iron man (.json')
final _charactersIronMan2 = _$_charactersIronMan2JsonLiteral;

@JsonLiteral('lib/example/marvel/src/json/character_1009368.json')
