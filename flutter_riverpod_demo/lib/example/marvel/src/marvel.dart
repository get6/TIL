/// This file contains the necessary object to connect with the Marvel API.
///
...
import 'package:flutter_riverpod_demo/example/marvel/src/configuration.dart';
...
final repositoryProvider =
    Provider<MarvelRepository>((ref) => MarvelRepository(ref.read));
...
@freezed
abstract class MarvelListCharactersResponse
    with _$MarvelListCharactersResponse {
