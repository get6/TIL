...
def sublist_max(profits, start, end):
    ...
    max_sum = max_crossing_sum(profits, start, end)

    mid = (start + end) // 2
    left_profit = sublist_max(profits, start, mid)
    right_profit = sublist_max(profits, mid + 1, end)

    return max(max_sum, max(left_profit, right_profit))
